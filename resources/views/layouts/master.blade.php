  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><a href="{{url('setting')}}"><i class="fa fa-gears"></i> <span>Settings</span></a></li>
        <li class="">
...
<script>
  ...
  $('#edit').on('show.bs.modal', function (event) {
      ...
      modal.find('.modal-body #product_code').val(code);
//      modal.find('.modal-body #product_image').val(image);
